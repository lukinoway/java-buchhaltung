...
/** Author: lukinoway
 * Function Interface which should be used for Transaktion Operation
 */
public interface ITransaktion {
	...
	public ArrayList<Transaktion> selectDataByTimeType(LocalDate begin, LocalDate end, int kontoId, int transaktionsType);
